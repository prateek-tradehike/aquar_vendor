...
/**
 * Observer for order feed indexation during shipment operation
 */
class ReindexOrderFeedOnShipment implements ObserverInterface
{
    /**
    ...
    public function execute(Observer $observer)
    {
        ...
        if (!$indexer->isScheduled()) {
            ...
            $indexer->reindexList([$shipment->getOrder()->getId()]);
        }
    }
}
